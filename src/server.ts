...
// When running from dist, go up 2 levels; when running from src with tsx, go up 2 levels
// Both end up at pizzaz_server_node directory, then we need to go to openai-apps-sdk-examples
const ROOT_DIR = path.resolve(__dirname, "..", "..", "openai-apps-sdk-examples");
